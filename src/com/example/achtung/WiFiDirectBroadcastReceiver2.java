...
public class WiFiDirectBroadcastReceiver2 extends BroadcastReceiver {
    ...
    public WiFiDirectBroadcastReceiver2(WifiP2pManager manager, Channel channel,
            FragmentWiFiDirectLobby aFragment) {
        super();
        this.mManager = manager;
        this.mChamnnel = channel;
...
//                        .findFragmentById(R.id.frag_list));
            	mManager.requestPeers(mChamnnel, mFragment);
...
//                manager.requestConnectionInfo(channel, fragment);
            	mManager.requestConnectionInfo(mChamnnel, mFragment);
            } else {
                // It's a disconnect
//                activity.resetData();
            }
